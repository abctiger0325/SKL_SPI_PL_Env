...
HD_PWD='/home/labish/Midget/SKL/SKL_SPI_PL_Env/SKL_Zed_PS_SPI.tmp/PL_MatchFilter_v1_0_project/PL_MatchFilter_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PL_MatchFilter_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PL_MatchFilter_v1_0.tcl
