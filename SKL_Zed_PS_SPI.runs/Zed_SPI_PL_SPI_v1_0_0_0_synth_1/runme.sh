...
HD_PWD='C:/Users/0/Midget/SKL/SKL_Zed_PS_SPI/SKL_Zed_PS_SPI.runs/Zed_SPI_PL_SPI_v1_0_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zed_SPI_PL_SPI_v1_0_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zed_SPI_PL_SPI_v1_0_0_0.tcl
