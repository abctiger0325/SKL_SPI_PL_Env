...
HD_PWD='/home/labish/Midget/SKL/SKL_SPI_PL_Env/SKL_Zed_PS_SPI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zed_SPI_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zed_SPI_wrapper.tcl
