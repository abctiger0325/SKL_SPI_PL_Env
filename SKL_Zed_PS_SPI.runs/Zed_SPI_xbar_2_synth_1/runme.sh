...
HD_PWD='C:/Users/0/Midget/SKL/SKL_Zed_PS_SPI/SKL_Zed_PS_SPI.runs/Zed_SPI_xbar_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zed_SPI_xbar_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zed_SPI_xbar_2.tcl
