...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_9910 is
  port (
    ...
    \r_Over_Cnt_reg[0]_P_1\ : out STD_LOGIC;
    ...
    \r_Over_Cnt_reg[3]_C_1\ : in STD_LOGIC;
    \r_Over_Cnt_reg[2]_C_1\ : in STD_LOGIC;
    \r_Over_Cnt_reg[1]_C_2\ : in STD_LOGIC;
    \r_Over_Cnt_reg[0]_C_1\ : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_9910 is
  ...
  signal \p_0_out__0\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  signal \^r_over_cnt_reg[0]_p_1\ : STD_LOGIC;
  signal \^r_over_cnt_reg[1]_c_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \r_GPIO[1]_i_1\ : label is "soft_lutpair202";
  attribute SOFT_HLUTNM of \r_GPIO[4]_i_1\ : label is "soft_lutpair202";
...
begin
  ...
  \r_Over_Cnt_reg[0]_P_1\ <= \^r_over_cnt_reg[0]_p_1\;
  \r_Over_Cnt_reg[1]_C_0\ <= \^r_over_cnt_reg[1]_c_0\;
...
p_0_out: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\r_GPIO[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F2"
        ...
        port map (
      I0 => Q(0),
      I1 => \r_GPIO[3]_i_1_n_0\,
      I2 => \^o_gpio\(0),
      O => \r_GPIO[1]_i_1_n_0\
    );
\r_GPIO[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFF8"
    )
        port map (
      I0 => r_Over_Lock,
      I1 => i_Over_GPIO,
      I2 => \r_Over_Cnt_reg[2]_C_1\,
      I3 => \r_Over_Cnt_reg[3]_C_1\,
      I4 => \r_Over_Cnt_reg[1]_C_2\,
      O => \r_GPIO[3]_i_1_n_0\
    );
...
\r_Over_Cnt_reg[0]_LDC_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"202A0000"
        ...
        port map (
      I0 => \r_GPIO[3]_i_1_n_0\,
      I1 => \^r_over_cnt_reg[0]_p_1\,
      I2 => \^r_over_cnt_reg[0]_p_0\,
      I3 => \^r_over_cnt_reg[0]_c_0\,
      I4 => r_Over_Lock_i_3_n_0,
...
\r_Over_Cnt_reg[2]_LDC_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0078"
    )
        port map (
      I0 => \r_Over_Cnt_reg[0]_C_1\,
      I1 => \r_Over_Cnt_reg[1]_C_2\,
      I2 => \r_Over_Cnt_reg[2]_C_1\,
      I3 => \r_Over_Cnt_reg[3]_C_1\,
...
\r_Over_Cnt_reg[2]_LDC_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFF0000F88"
    )
        port map (
      I0 => i_Over_GPIO,
      I1 => r_Over_Lock,
      I2 => \r_Over_Cnt_reg[0]_C_1\,
      I3 => \r_Over_Cnt_reg[1]_C_2\,
      I4 => \r_Over_Cnt_reg[2]_C_1\,
      I5 => \r_Over_Cnt_reg[3]_C_1\,
...
\r_Over_Cnt_reg[3]_LDC_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0580"
    )
        port map (
      I0 => \r_Over_Cnt_reg[1]_C_2\,
      I1 => \r_Over_Cnt_reg[0]_C_1\,
      I2 => \r_Over_Cnt_reg[2]_C_1\,
      I3 => \r_Over_Cnt_reg[3]_C_1\,
...
\r_Over_Cnt_reg[3]_LDC_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFF0F00FFFF8F8"
    )
        port map (
      I0 => i_Over_GPIO,
      I1 => r_Over_Lock,
      I2 => \r_Over_Cnt_reg[1]_C_2\,
      I3 => \r_Over_Cnt_reg[0]_C_1\,
      I4 => \r_Over_Cnt_reg[2]_C_1\,
      I5 => \r_Over_Cnt_reg[3]_C_1\,
...
r_Over_Lock_i_3: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \r_Over_Cnt_reg[1]_C_2\,
      I4 => \r_Over_Cnt_reg[0]_C_1\,
      I5 => \r_Over_Cnt_reg[2]_C_1\,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_DDS_v1_0_S00_AXI is
  ...
  signal \r_Over_Cnt[0]_C_i_1_n_0\ : STD_LOGIC;
  signal \r_Over_Cnt[1]_C_i_1_n_0\ : STD_LOGIC;
  signal \r_Over_Cnt[2]_C_i_1_n_0\ : STD_LOGIC;
  signal \r_Over_Cnt[3]_C_i_1_n_0\ : STD_LOGIC;
...
SPI: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_9910
     port map (
      ...
      r_Halfbit_state_reg_0 => SPI_n_3,
      \r_Over_Cnt_reg[0]_C_0\ => SPI_n_20,
      \r_Over_Cnt_reg[0]_C_1\ => \r_Over_Cnt[0]_C_i_1_n_0\,
      \r_Over_Cnt_reg[0]_P_0\ => SPI_n_8,
      \r_Over_Cnt_reg[0]_P_1\ => SPI_n_21,
      \r_Over_Cnt_reg[1]_C_0\ => SPI_n_7,
      \r_Over_Cnt_reg[1]_C_1\ => SPI_n_18,
      \r_Over_Cnt_reg[1]_C_2\ => \r_Over_Cnt[1]_C_i_1_n_0\,
      \r_Over_Cnt_reg[1]_P_0\ => SPI_n_19,
      \r_Over_Cnt_reg[2]_C_0\ => SPI_n_16,
      \r_Over_Cnt_reg[2]_C_1\ => \r_Over_Cnt[2]_C_i_1_n_0\,
      \r_Over_Cnt_reg[2]_P_0\ => SPI_n_17,
      \r_Over_Cnt_reg[3]_C_0\ => SPI_n_14,
      \r_Over_Cnt_reg[3]_C_1\ => \r_Over_Cnt[3]_C_i_1_n_0\,
