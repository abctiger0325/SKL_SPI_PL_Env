...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_9910 is
  ...
  attribute SOFT_HLUTNM of \r_GPIO[2]_i_1\ : label is "soft_lutpair202";
  attribute SOFT_HLUTNM of \r_GPIO[3]_i_1\ : label is "soft_lutpair202";
...
\r_GPIO[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EA2A"
    )
        port map (
      I0 => \r_GPIO_reg[4]_0\(0),
      I1 => \^r_over_lock\,
      I2 => i_Over_GPIO,
      I3 => \^o_gpio\(0),
      O => \r_GPIO[0]_i_1_n_0\
    );
\r_GPIO[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EA2A"
    )
        port map (
...
\r_GPIO[2]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\r_GPIO[3]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
        ...
        port map (
      I0 => \r_GPIO_reg[4]_0\(3),
      I1 => \^r_over_lock\,
      O => \r_GPIO[3]_i_1_n_0\
    );
\r_GPIO[3]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\r_GPIO_reg[2]\: unisim.vcomponents.FDPE
    generic map(
      INIT => '0'
    )
        port map (
...
SPI: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_9910
     port map (
      ...
      \r_TX_Bit_Count_reg[2]_0\ => SPI_n_15,
      r_TX_reg_0 => SPI_n_1,
