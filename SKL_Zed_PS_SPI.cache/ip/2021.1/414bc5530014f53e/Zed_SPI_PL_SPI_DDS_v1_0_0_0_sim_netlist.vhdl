...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_9910 is
  port (
    ...
    \r_Over_Cnt_reg[2]_P_1\ : out STD_LOGIC;
    ...
    \r_GPIO_reg[0]_LDC_i_2_0\ : out STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_9910 is
  ...
  signal p_1_out : STD_LOGIC_VECTOR ( 3 downto 1 );
  ...
  signal \r_GPIO_reg[0]_LDC_i_3_n_0\ : STD_LOGIC;
  ...
  signal \^r_over_cnt_reg[2]_p_1\ : STD_LOGIC;
...
begin
  ...
  \r_Over_Cnt_reg[2]_P_1\ <= \^r_over_cnt_reg[2]_p_1\;
  r_Over_Lock <= \^r_over_lock\;
...
\r_GPIO_reg[0]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      GE => '1',
      Q => \r_GPIO_reg[0]_LDC_i_2_0\
    );
\r_GPIO_reg[0]_LDC_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => \r_GPIO[4]_i_2_n_0\,
      I1 => \r_GPIO_reg[0]_LDC_i_3_n_0\,
      O => \r_GPIO_reg[0]_LDC_i_1_n_0\
    );
\r_GPIO_reg[0]_LDC_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\r_GPIO_reg[0]_LDC_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0888808080808080"
    )
        port map (
      I0 => \r_Over_Cnt_reg[3]_LDC_n_0\,
      I1 => \r_Over_Cnt_reg[3]_P_n_0\,
      I2 => r_Over_Cnt(1),
      I3 => r_Over_Cnt(0),
      I4 => \^r_over_cnt_reg[2]_p_1\,
      I5 => \^r_over_cnt_reg[2]_p_0\,
      O => \r_GPIO_reg[0]_LDC_i_3_n_0\
    );
...
\r_Over_Cnt_reg[1]_LDC_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => \^r_over_cnt_reg[1]_p_1\,
      I3 => \^r_over_cnt_reg[0]_p_0\,
      I4 => \^r_over_cnt_reg[0]_p_1\,
...
\r_Over_Cnt_reg[2]_LDC_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \^r_over_cnt_reg[2]_p_1\,
      I3 => \^r_over_cnt_reg[1]_p_1\,
...
\r_Over_Cnt_reg[3]_LDC_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
        ...
        port map (
      I0 => \^r_over_cnt_reg[1]_p_1\,
      I1 => \^r_over_cnt_reg[1]_p_0\,
      I2 => \^r_over_cnt_reg[0]_p_1\,
      I3 => \^r_over_cnt_reg[0]_p_0\,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_DDS_v1_0_S00_AXI is
  ...
  signal r_Over_Cnt : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal r_Over_Lock : STD_LOGIC;
...
SPI: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_9910
     port map (
      ...
      \r_GPIO_reg[0]_C_0\ => SPI_n_9,
      \r_GPIO_reg[0]_LDC_i_2_0\ => SPI_n_8,
      \r_GPIO_reg[0]_P_0\ => SPI_n_10,
      ...
      r_Over_Cnt(2 downto 0) => r_Over_Cnt(2 downto 0),
      \r_Over_Cnt_reg[0]_P_0\ => SPI_n_6,
      \r_Over_Cnt_reg[0]_P_1\ => SPI_n_7,
      \r_Over_Cnt_reg[1]_P_0\ => SPI_n_4,
      \r_Over_Cnt_reg[1]_P_1\ => SPI_n_5,
      \r_Over_Cnt_reg[2]_P_0\ => SPI_n_2,
      \r_Over_Cnt_reg[2]_P_1\ => SPI_n_3,
      r_Over_Lock => r_Over_Lock,
      r_Over_Lock_reg_0 => r_Over_Lock_i_1_n_0,
      ...
      \r_TX_Bit_Count_reg[2]_0\ => SPI_n_24,
      r_TX_reg_0 => SPI_n_1,
...
\r_GPIO[4]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
