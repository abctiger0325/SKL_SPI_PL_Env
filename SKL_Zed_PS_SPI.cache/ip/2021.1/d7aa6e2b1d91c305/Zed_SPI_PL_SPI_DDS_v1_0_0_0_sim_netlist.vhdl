...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_9910 is
  port (
    ...
    \r_Over_Cnt_reg[1]_C_0\ : out STD_LOGIC;
    \r_Over_Cnt_reg[1]_P_0\ : out STD_LOGIC;
    \r_Over_Cnt_reg[0]_C_0\ : out STD_LOGIC;
    \r_Over_Cnt_reg[3]_C_0\ : out STD_LOGIC;
    \r_GPIO_reg[0]_C_0\ : out STD_LOGIC;
    \r_GPIO_reg[0]_P_0\ : out STD_LOGIC;
    r_CmdAccept : out STD_LOGIC;
    r_Send_reg_0 : out STD_LOGIC;
    r_SPI_CS_reg_0 : out STD_LOGIC;
    o_SPI_Clk : out STD_LOGIC;
    o_SPI_MOSI : out STD_LOGIC;
    \r_Over_Cnt_reg[3]_C_1\ : out STD_LOGIC;
    \r_Over_Cnt_reg[3]_P_1\ : out STD_LOGIC;
    \r_Over_Cnt_reg[2]_C_0\ : out STD_LOGIC;
    \r_Over_Cnt_reg[2]_P_0\ : out STD_LOGIC;
    \r_Over_Cnt_reg[1]_C_1\ : out STD_LOGIC;
    \r_Over_Cnt_reg[1]_P_1\ : out STD_LOGIC;
    \r_Over_Cnt_reg[0]_C_1\ : out STD_LOGIC;
    ...
    o_GPIO : in STD_LOGIC_VECTOR ( 0 to 0 );
    r_CmdAccept_reg_1 : in STD_LOGIC;
    r_SPI_Clk_reg_0 : in STD_LOGIC;
    r_SPI_MOSI_reg_0 : in STD_LOGIC;
    r_Over_Cnt : in STD_LOGIC_VECTOR ( 3 downto 0 );
    \r_GPIO_reg[4]_1\ : in STD_LOGIC;
    ...
    \r_GPIO_reg[4]_2\ : in STD_LOGIC_VECTOR ( 2 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_9910 is
  ...
  signal \r_GPIO_reg[0]_LDC_i_1_n_0\ : STD_LOGIC;
  signal \r_GPIO_reg[0]_LDC_i_2_n_0\ : STD_LOGIC;
  ...
  signal \^r_over_cnt_reg[0]_c_0\ : STD_LOGIC;
  signal \^r_over_cnt_reg[0]_c_1\ : STD_LOGIC;
  ...
  signal \^r_over_cnt_reg[1]_c_1\ : STD_LOGIC;
  ...
  signal \^r_over_cnt_reg[3]_p_1\ : STD_LOGIC;
  ...
  attribute XILINX_LEGACY_PRIM of \r_GPIO_reg[0]_LDC\ : label is "LDC";
...
begin
  ...
  \r_Over_Cnt_reg[0]_C_0\ <= \^r_over_cnt_reg[0]_c_0\;
  \r_Over_Cnt_reg[0]_C_1\ <= \^r_over_cnt_reg[0]_c_1\;
  \r_Over_Cnt_reg[0]_P_0\ <= \^r_over_cnt_reg[0]_p_0\;
  \r_Over_Cnt_reg[1]_C_1\ <= \^r_over_cnt_reg[1]_c_1\;
  \r_Over_Cnt_reg[1]_P_0\ <= \^r_over_cnt_reg[1]_p_0\;
  \r_Over_Cnt_reg[1]_P_1\ <= \^r_over_cnt_reg[1]_p_1\;
  \r_Over_Cnt_reg[3]_C_1\ <= \^r_over_cnt_reg[3]_c_1\;
  \r_Over_Cnt_reg[3]_P_0\ <= \^r_over_cnt_reg[3]_p_0\;
  \r_Over_Cnt_reg[3]_P_1\ <= \^r_over_cnt_reg[3]_p_1\;
...
\r_GPIO[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \r_GPIO_reg[4]_2\(0),
      I1 => \^r_gpio_reg[4]_0\(0),
      O => p_0_out(1)
    );
\r_GPIO[3]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => \^r_gpio_reg[4]_0\(1),
      I1 => \r_GPIO_reg[4]_2\(1),
      O => p_0_out(3)
    );
\r_GPIO[4]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
      I0 => \^r_gpio_reg[4]_0\(2),
      I1 => \r_GPIO_reg[4]_1\,
      I2 => \r_GPIO_reg[4]_2\(2),
      O => \r_GPIO[4]_i_1_n_0\
    );
\r_GPIO_reg[0]_C\: unisim.vcomponents.FDCE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      CLR => \r_GPIO_reg[0]_LDC_i_2_n_0\,
      D => o_GPIO(0),
      Q => \r_GPIO_reg[0]_C_0\
    );
\r_GPIO_reg[0]_LDC\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
      CLR => \r_GPIO_reg[0]_LDC_i_2_n_0\,
      D => '1',
      G => \r_GPIO_reg[0]_LDC_i_1_n_0\,
      GE => '1',
      Q => \r_Over_Cnt_reg[3]_C_0\
    );
\r_GPIO_reg[0]_LDC_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"858585FAFAFA85FA"
    )
        port map (
      I0 => r_Over_Cnt(2),
      I1 => r_Over_Cnt(0),
      I2 => r_Over_Cnt(1),
      I3 => \^r_over_cnt_reg[3]_c_1\,
      I4 => \^r_over_cnt_reg[3]_p_0\,
      I5 => \^r_over_cnt_reg[3]_p_1\,
      O => \r_GPIO_reg[0]_LDC_i_1_n_0\
    );
\r_GPIO_reg[0]_LDC_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7A7A7A0000007A00"
    )
        port map (
      I0 => r_Over_Cnt(2),
      I1 => r_Over_Cnt(0),
      ...
      I4 => \^r_over_cnt_reg[3]_p_0\,
      I5 => \^r_over_cnt_reg[3]_p_1\,
      O => \r_GPIO_reg[0]_LDC_i_2_n_0\
    );
\r_GPIO_reg[0]_P\: unisim.vcomponents.FDPE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => o_GPIO(0),
      PRE => \r_GPIO_reg[0]_LDC_i_1_n_0\,
      Q => \r_GPIO_reg[0]_P_0\
    );
\r_GPIO_reg[1]\: unisim.vcomponents.FDPE
    generic map(
      INIT => '0'
    )
        port map (
...
\r_GPIO_reg[4]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\r_Over_Cnt_reg[0]_C\: unisim.vcomponents.FDCE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      CLR => \r_Over_Cnt_reg[0]_LDC_i_2_n_0\,
      D => r_Over_Cnt(0),
      Q => \^r_over_cnt_reg[0]_c_1\
    );
...
\r_Over_Cnt_reg[0]_LDC_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"02A2"
        ...
        port map (
      I0 => \r_GPIO_reg[4]_1\,
      I1 => \^r_over_cnt_reg[0]_c_1\,
      I2 => \^r_over_cnt_reg[0]_c_0\,
...
\r_Over_Cnt_reg[1]_C\: unisim.vcomponents.FDCE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      CLR => \r_Over_Cnt_reg[1]_LDC_i_2_n_0\,
      D => r_Over_Cnt(1),
      Q => \^r_over_cnt_reg[1]_c_1\
    );
...
\r_Over_Cnt_reg[1]_LDC_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"202A8A80"
        ...
        port map (
      I0 => \r_GPIO_reg[4]_1\,
      I1 => \^r_over_cnt_reg[1]_p_1\,
      I2 => \^r_over_cnt_reg[1]_p_0\,
      I3 => \^r_over_cnt_reg[1]_c_1\,
      I4 => r_Over_Cnt(0),
...
\r_Over_Cnt_reg[1]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      Q => \^r_over_cnt_reg[1]_p_1\
    );
\r_Over_Cnt_reg[2]_C\: unisim.vcomponents.FDCE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      CLR => \r_Over_Cnt_reg[2]_LDC_i_2_n_0\,
      D => r_Over_Cnt(2),
      Q => \r_Over_Cnt_reg[2]_C_0\
    );
\r_Over_Cnt_reg[2]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      GE => '1',
      Q => \r_Over_Cnt_reg[1]_C_0\
    );
\r_Over_Cnt_reg[2]_LDC_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2228882888888888"
    )
        port map (
      I0 => \r_GPIO_reg[4]_1\,
      I1 => r_Over_Cnt(2),
      I2 => \^r_over_cnt_reg[1]_c_1\,
      I3 => \^r_over_cnt_reg[1]_p_0\,
      I4 => \^r_over_cnt_reg[1]_p_1\,
      I5 => r_Over_Cnt(0),
...
\r_Over_Cnt_reg[3]_C\: unisim.vcomponents.FDCE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      CLR => \r_Over_Cnt_reg[3]_LDC_i_2_n_0\,
      D => r_Over_Cnt(3),
      Q => \^r_over_cnt_reg[3]_c_1\
    );
...
\r_Over_Cnt_reg[3]_LDC_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"47B8B8B8B8B8B8B8"
        ...
        port map (
      I0 => \^r_over_cnt_reg[3]_p_1\,
      I1 => \^r_over_cnt_reg[3]_p_0\,
      I2 => \^r_over_cnt_reg[3]_c_1\,
      I3 => r_Over_Cnt(2),
      I4 => r_Over_Cnt(0),
      I5 => r_Over_Cnt(1),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_DDS_v1_0_S00_AXI is
  ...
  signal \^o_gpio\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  signal r_Over_Cnt : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \axi_araddr[4]_i_1\ : label is "soft_lutpair203";
  attribute SOFT_HLUTNM of axi_arready_i_1 : label is "soft_lutpair203";
  ...
  attribute SOFT_HLUTNM of \r_GPIO[4]_i_2\ : label is "soft_lutpair202";
  attribute SOFT_HLUTNM of \r_Over_Cnt[3]_C_i_1\ : label is "soft_lutpair202";
begin
  S_AXI_ARREADY <= \^s_axi_arready\;
  S_AXI_AWREADY <= \^s_axi_awready\;
  S_AXI_WREADY <= \^s_axi_wready\;
  o_GPIO(3 downto 0) <= \^o_gpio\(3 downto 0);
  o_SPI_Clk <= \^o_spi_clk\;
...
SPI: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_9910
     port map (
      ...
      r_CmdAccept => r_CmdAccept,
      r_CmdAccept40_out => r_CmdAccept40_out,
      r_CmdAccept_reg_0 => SPI_n_24,
      r_CmdAccept_reg_1 => r_CmdAccept_i_1_n_0,
      \r_GPIO_reg[0]_C_0\ => SPI_n_7,
      \r_GPIO_reg[0]_P_0\ => SPI_n_8,
      \r_GPIO_reg[4]_0\(2 downto 0) => \^o_gpio\(3 downto 1),
      \r_GPIO_reg[4]_1\ => \r_GPIO[4]_i_2_n_0\,
      \r_GPIO_reg[4]_2\(2 downto 1) => slv_reg4(4 downto 3),
      \r_GPIO_reg[4]_2\(0) => slv_reg4(1),
      \r_Halfbit_Cnt_reg[1]_0\ => SPI_n_26,
      \r_Halfbit_Cnt_reg[5]_0\ => SPI_n_23,
      r_Halfbit_state_reg_0 => SPI_n_0,
      r_Over_Cnt(3 downto 0) => r_Over_Cnt(3 downto 0),
      \r_Over_Cnt_reg[0]_C_0\ => SPI_n_5,
      \r_Over_Cnt_reg[0]_C_1\ => SPI_n_20,
      \r_Over_Cnt_reg[0]_P_0\ => SPI_n_21,
      \r_Over_Cnt_reg[1]_C_0\ => SPI_n_3,
      \r_Over_Cnt_reg[1]_C_1\ => SPI_n_18,
      \r_Over_Cnt_reg[1]_P_0\ => SPI_n_4,
      \r_Over_Cnt_reg[1]_P_1\ => SPI_n_19,
      \r_Over_Cnt_reg[2]_C_0\ => SPI_n_16,
      \r_Over_Cnt_reg[2]_P_0\ => SPI_n_17,
      \r_Over_Cnt_reg[3]_C_0\ => SPI_n_6,
      \r_Over_Cnt_reg[3]_C_1\ => SPI_n_14,
      \r_Over_Cnt_reg[3]_P_0\ => SPI_n_2,
      \r_Over_Cnt_reg[3]_P_1\ => SPI_n_15,
      ...
      \slv_reg0_reg[0]\ => SPI_n_22,
      \slv_reg0_reg[0]_0\ => SPI_n_25,
      \slv_reg2_reg[0]\ => \^s_axi_wready\,
      \slv_reg2_reg[0]_0\ => \^s_axi_awready\,
      \slv_reg3_reg[4]\ => SPI_n_28,
...
\o_GPIO[0]_INST_0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\r_Over_Cnt[0]_C_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\r_Over_Cnt[1]_C_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\r_Over_Cnt[2]_C_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\r_Over_Cnt[3]_C_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_DDS_v1_0
     port map (
      ...
      i_SPI_MISO => i_SPI_MISO,
      o_GPIO(3 downto 2) => \^o_gpio\(4 downto 3),
      o_GPIO(1 downto 0) => \^o_gpio\(1 downto 0),
      o_SPI_Clk => o_SPI_Clk,
      o_SPI_MOSI => o_SPI_MOSI,
