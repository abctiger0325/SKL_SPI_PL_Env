...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_9910 is
  port (
    ...
    r_Over_Lock_reg_1 : out STD_LOGIC;
    r_Over_Lock_reg_2 : out STD_LOGIC;
    r_Over_Lock_reg_3 : out STD_LOGIC;
    ...
    \r_GPIO_reg[4]_1\ : in STD_LOGIC_VECTOR ( 2 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_9910 is
  ...
  signal \^r_over_cnt_reg[3]_c_0\ : STD_LOGIC;
...
begin
  ...
  \r_Over_Cnt_reg[3]_C_0\ <= \^r_over_cnt_reg[3]_c_0\;
  \r_Over_Cnt_reg[3]_P_0\ <= \^r_over_cnt_reg[3]_p_0\;
  r_Over_Lock_reg_0 <= \^r_over_lock_reg_0\;
  r_Over_Lock_reg_1 <= \^r_over_lock_reg_1\;
  r_Over_Lock_reg_2 <= \^r_over_lock_reg_2\;
...
\r_GPIO[3]_i_1\: unisim.vcomponents.LUT2
    generic map(
      ...
      I1 => \r_GPIO_reg[4]_1\(1),
      O => p_0_out(3)
    );
\r_GPIO[4]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BF80"
    )
        port map (
      ...
      I1 => i_Over_GPIO,
      I2 => r_Over_Lock,
      I3 => \r_GPIO_reg[4]_1\(2),
      O => \r_GPIO[4]_i_1_n_0\
    );
\r_GPIO[4]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\r_GPIO_reg[0]_LDC_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\r_Over_Cnt_reg[0]_LDC_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00088808"
    )
        port map (
      ...
      I3 => \^r_over_lock_reg_2\,
      I4 => \^r_over_cnt_reg[0]_p_0\,
      O => \r_Over_Cnt_reg[0]_LDC_i_1_n_0\
    );
\r_Over_Cnt_reg[0]_LDC_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"88800080"
    )
        port map (
...
\r_Over_Cnt_reg[1]_LDC_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \^r_over_lock_reg_1\,
      I4 => \^r_over_cnt_reg[1]_c_1\,
      I5 => r_Over_Cnt(0),
...
\r_Over_Cnt_reg[3]_LDC_i_1\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => r_Over_Lock,
      I1 => i_Over_GPIO,
      I2 => \r_Over_Cnt_reg[3]_LDC_i_3_n_0\,
...
r_Over_Lock_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
r_Over_Lock_i_3: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FF47474747FF47FF"
    )
        port map (
      I0 => \^r_over_cnt_reg[3]_p_0\,
      I1 => \^r_over_lock_reg_0\,
      I2 => \^r_over_cnt_reg[3]_c_0\,
      I3 => r_Over_Cnt(1),
      I4 => r_Over_Cnt(0),
      I5 => r_Over_Cnt(2),
      O => p_3_in
    );
r_Over_Lock_reg: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
SPI: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_9910
     port map (
      ...
      \r_GPIO_reg[4]_1\(2 downto 1) => slv_reg4(4 downto 3),
      \r_GPIO_reg[4]_1\(0) => slv_reg4(1),
      ...
      \r_Over_Cnt_reg[0]_C_0\ => SPI_n_20,
      \r_Over_Cnt_reg[0]_P_0\ => SPI_n_21,
      \r_Over_Cnt_reg[1]_C_0\ => SPI_n_3,
      \r_Over_Cnt_reg[1]_C_1\ => SPI_n_18,
      \r_Over_Cnt_reg[1]_P_0\ => SPI_n_19,
      \r_Over_Cnt_reg[2]_C_0\ => SPI_n_16,
      \r_Over_Cnt_reg[2]_P_0\ => SPI_n_17,
      \r_Over_Cnt_reg[3]_C_0\ => SPI_n_14,
      \r_Over_Cnt_reg[3]_P_0\ => SPI_n_15,
      r_Over_Lock_reg_0 => SPI_n_2,
      r_Over_Lock_reg_1 => SPI_n_4,
      r_Over_Lock_reg_2 => SPI_n_5,
      r_Over_Lock_reg_3 => SPI_n_6,
