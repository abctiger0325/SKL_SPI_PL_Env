...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_9910 is
  port (
    ...
    \r_GPIO_reg[3]_0\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
...
\r_GPIO_reg[1]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_DDS_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of \r_GPIO[3]_i_2\ : label is "soft_lutpair204";
  attribute SOFT_HLUTNM of r_Over_Lock_i_1 : label is "soft_lutpair204";
begin
...
SPI: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_9910
     port map (
      ...
      \r_GPIO_reg[3]_0\(1) => p_0_out(3),
      \r_GPIO_reg[3]_0\(0) => slv_reg4(1),
      \r_GPIO_reg[4]_0\(1) => slv_reg4(4),
      \r_GPIO_reg[4]_0\(0) => slv_reg4(0),
