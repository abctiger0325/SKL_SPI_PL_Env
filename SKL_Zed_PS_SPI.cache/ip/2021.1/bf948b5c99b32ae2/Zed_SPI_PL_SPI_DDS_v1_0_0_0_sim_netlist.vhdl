...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_9910 is
  ...
  signal \o_LED_Temp_reg[3]_LDC_i_1_n_0\ : STD_LOGIC;
  signal \o_LED_Temp_reg[3]_LDC_i_2_n_0\ : STD_LOGIC;
  ...
  signal \r_Over_Cnt_reg[2]_P_n_0\ : STD_LOGIC;
  ...
  signal \r_Over_Cnt_reg[3]_LDC_i_4_n_0\ : STD_LOGIC;
  signal \r_Over_Cnt_reg[3]_LDC_i_5_n_0\ : STD_LOGIC;
  signal \r_Over_Cnt_reg[3]_LDC_n_0\ : STD_LOGIC;
  signal \r_Over_Cnt_reg[3]_P_n_0\ : STD_LOGIC;
...
\o_LED_Temp_reg[2]_LDC_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7888888800000000"
    )
        port map (
      I0 => \r_Over_Cnt_reg[2]_LDC_n_0\,
      I1 => \r_Over_Cnt_reg[2]_P_n_0\,
      I2 => \r_Over_Cnt_reg[1]_P_n_0\,
      I3 => \r_Over_Cnt_reg[1]_LDC_n_0\,
      I4 => \o_LED_Temp_reg[2]_P_1\,
      I5 => i_Over_GPIO,
      O => \o_LED_Temp_reg[2]_LDC_i_1_n_0\
    );
\o_LED_Temp_reg[2]_LDC_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"802A2A2A2A2A2A2A"
    )
        port map (
      I0 => i_Over_GPIO,
      I1 => \r_Over_Cnt_reg[2]_LDC_n_0\,
      I2 => \r_Over_Cnt_reg[2]_P_n_0\,
      I3 => \r_Over_Cnt_reg[1]_P_n_0\,
      I4 => \r_Over_Cnt_reg[1]_LDC_n_0\,
...
\o_LED_Temp_reg[3]_C\: unisim.vcomponents.FDCE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      CLR => \o_LED_Temp_reg[3]_LDC_i_2_n_0\,
      D => o_LED(3),
...
\o_LED_Temp_reg[3]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \o_LED_Temp_reg[3]_LDC_i_2_n_0\,
      D => '1',
      G => \o_LED_Temp_reg[3]_LDC_i_1_n_0\,
      GE => '1',
      Q => i_Over_GPIO_1
    );
\o_LED_Temp_reg[3]_LDC_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => \r_Over_Cnt_reg[3]_LDC_i_4_n_0\,
      I1 => i_Over_GPIO,
      O => \o_LED_Temp_reg[3]_LDC_i_1_n_0\
    );
\o_LED_Temp_reg[3]_LDC_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => i_Over_GPIO,
      I1 => \r_Over_Cnt_reg[3]_LDC_i_4_n_0\,
      O => \o_LED_Temp_reg[3]_LDC_i_2_n_0\
    );
\o_LED_Temp_reg[3]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => o_LED(3),
      PRE => \o_LED_Temp_reg[3]_LDC_i_1_n_0\,
...
\r_Over_Cnt_reg[0]_LDC_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I3 => \r_Over_Cnt_reg[3]_LDC_i_3_n_0\,
...
\r_Over_Cnt_reg[1]_LDC_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \^r_over_cnt_reg[0]_p_0\,
      I3 => \^i_over_gpio_0\,
      I4 => \r_Over_Cnt_reg[1]_P_n_0\,
      I5 => \r_Over_Cnt_reg[1]_LDC_n_0\,
...
\r_Over_Cnt_reg[2]_LDC_i_1\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => i_Over_GPIO,
      I1 => \r_Over_Cnt_reg[3]_LDC_i_3_n_0\,
      I2 => \r_Over_Cnt_reg[2]_LDC_i_3_n_0\,
...
\r_Over_Cnt_reg[2]_LDC_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \r_Over_Cnt_reg[1]_P_n_0\,
      I4 => \r_Over_Cnt_reg[2]_P_n_0\,
      I5 => \r_Over_Cnt_reg[2]_LDC_n_0\,
...
\r_Over_Cnt_reg[3]_LDC_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"20"
    )
        port map (
      I0 => i_Over_GPIO,
      I1 => \r_Over_Cnt_reg[3]_LDC_i_3_n_0\,
      I2 => \r_Over_Cnt_reg[3]_LDC_i_4_n_0\,
      O => \r_Over_Cnt_reg[3]_LDC_i_1_n_0\
    );
\r_Over_Cnt_reg[3]_LDC_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"8A"
    )
        port map (
...
\r_Over_Cnt_reg[3]_LDC_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000800080008"
    )
        port map (
      I0 => \r_Over_Cnt_reg[2]_P_n_0\,
      I1 => \r_Over_Cnt_reg[2]_LDC_n_0\,
      I2 => \r_Over_Cnt_reg[3]_LDC_i_4_n_0\,
      I3 => \o_LED_Temp_reg[2]_P_1\,
      I4 => \r_Over_Cnt_reg[1]_P_n_0\,
      I5 => \r_Over_Cnt_reg[1]_LDC_n_0\,
      O => \r_Over_Cnt_reg[3]_LDC_i_3_n_0\
    );
\r_Over_Cnt_reg[3]_LDC_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7F808080"
    )
        port map (
      I0 => \r_Over_Cnt_reg[3]_LDC_i_5_n_0\,
      I1 => \r_Over_Cnt_reg[2]_LDC_n_0\,
      I2 => \r_Over_Cnt_reg[2]_P_n_0\,
      I3 => \r_Over_Cnt_reg[3]_P_n_0\,
      I4 => \r_Over_Cnt_reg[3]_LDC_n_0\,
      O => \r_Over_Cnt_reg[3]_LDC_i_4_n_0\
    );
\r_Over_Cnt_reg[3]_LDC_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
      I0 => \r_Over_Cnt_reg[1]_P_n_0\,
      I1 => \r_Over_Cnt_reg[1]_LDC_n_0\,
      I2 => \^r_over_cnt_reg[0]_p_0\,
      I3 => \^i_over_gpio_0\,
      O => \r_Over_Cnt_reg[3]_LDC_i_5_n_0\
    );
...
SPI: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_9910
     port map (
      ...
      i_Over_GPIO_0 => SPI_n_2,
      i_Over_GPIO_1 => SPI_n_4,
      i_Over_GPIO_2 => SPI_n_7,
      i_SPI_MISO => i_SPI_MISO,
      \i_TX_Byte_reg[30][7]_0\(7 downto 0) => slv_reg1(7 downto 0),
      o_GPIO(4 downto 0) => o_GPIO(4 downto 0),
      o_LED(3 downto 0) => \^o_led\(3 downto 0),
      \o_LED_Temp_reg[0]_C_0\ => SPI_n_19,
      \o_LED_Temp_reg[0]_P_0\ => SPI_n_20,
      \o_LED_Temp_reg[1]_C_0\ => SPI_n_17,
      \o_LED_Temp_reg[1]_P_0\ => SPI_n_18,
      \o_LED_Temp_reg[2]_C_0\ => SPI_n_15,
      \o_LED_Temp_reg[2]_P_0\ => SPI_n_16,
      \o_LED_Temp_reg[2]_P_1\ => \o_LED_Temp_reg[2]_LDC_i_3_n_0\,
      \o_LED_Temp_reg[3]_C_0\ => SPI_n_13,
      \o_LED_Temp_reg[3]_P_0\ => SPI_n_14,
      o_SPI_Clk => \^o_spi_clk\,
      o_SPI_MOSI => \^o_spi_mosi\,
      r_CmdAccept => r_CmdAccept,
      r_CmdAccept38_out => r_CmdAccept38_out,
      r_CmdAccept_reg_0 => SPI_n_23,
      r_CmdAccept_reg_1 => r_CmdAccept_i_1_n_0,
      \r_Halfbit_Cnt_reg[1]_0\ => SPI_n_25,
      \r_Halfbit_Cnt_reg[5]_0\ => SPI_n_22,
      r_Halfbit_state_reg_0 => SPI_n_0,
      \r_Over_Cnt_reg[0]_P_0\ => SPI_n_3,
      \r_Over_Cnt_reg[1]_P_0\ => SPI_n_6,
      \r_Over_Cnt_reg[2]_P_0\ => SPI_n_5,
