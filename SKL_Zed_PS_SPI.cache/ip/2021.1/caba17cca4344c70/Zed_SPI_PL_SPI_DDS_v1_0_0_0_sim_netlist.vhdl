...
SPI: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_9910
     port map (
      ...
      \r_Halfbit_Cnt_reg[2]_1\ => SPI_n_33,
      ...
      r_Send_reg_1 => SPI_n_34,
      \r_TX_Bit_Count_reg[2]_0\ => SPI_n_36,
      r_TX_reg_0 => SPI_n_1,
...
begin
  o_GPIO(7 downto 5) <= \^o_gpio\(7 downto 5);
  o_GPIO(4) <= \<const0>\;
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_DDS_v1_0
     port map (
      ...
      i_SPI_MISO => i_SPI_MISO,
      o_GPIO(6 downto 4) => \^o_gpio\(7 downto 5),
      o_GPIO(3 downto 0) => \^o_gpio\(3 downto 0),
      o_SPI_Clk => o_SPI_Clk,
      o_SPI_MOSI => o_SPI_MOSI,
