...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PL_SPI_ADC_MasterStream_v1_0_M00_AXIS is
  ...
  signal axis_tvalid_delay_i_5_n_0 : STD_LOGIC;
...
axis_tvalid_delay_i_3: unisim.vcomponents.LUT4
    generic map(
      ...
      I2 => \count_pointer_reg__0\(14),
      I3 => \count_pointer_reg__0\(17),
      O => axis_tvalid_delay_i_3_n_0
    );
axis_tvalid_delay_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"5557"
    )
        port map (
      I0 => count_pointer_reg(7),
      I1 => count_pointer_reg(5),
      I2 => count_pointer_reg(4),
      I3 => count_pointer_reg(6),
      O => axis_tvalid_delay_i_4_n_0
    );
axis_tvalid_delay_i_5: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      I3 => count_pointer_reg(11),
      O => axis_tvalid_delay_i_5_n_0
    );
...
r_FIFOCycle_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"3030F8F0"
    )
        port map (
      ...
      I1 => s00_axi_aresetn,
      I2 => r_FIFOCycle_reg_n_0,
      I3 => write_pointer0,
      I4 => \read_pointer_rep[15]_i_4_n_0\,
...
\read_pointer_rep[15]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\read_pointer_rep[15]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0800"
    )
        port map (
...
\read_pointer_rep[15]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0080"
    )
        port map (
...
\read_pointer_rep[15]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000002"
    )
        port map (
      I0 => \read_pointer_rep[15]_i_6_n_0\,
...
\read_pointer_rep[15]_i_6\: unisim.vcomponents.LUT6
    generic map(
