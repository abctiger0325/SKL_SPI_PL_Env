...
################################################################
# This is a generated script based on design: Zed_SPI
#
...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
user.org:user:PL_IO_TriggerCtrl_v1_0:1.0\
xilinx.com:user:PL_SPI_ADAR_v1_0:1.5\
user.org:user:PL_SPI_ADC_MasterStream_v1_0:1.1\
xilinx.com:user:PL_SPI_ADF4159_v1_0:1.0\
xilinx.com:user:PL_SPI_DDS_v1_0:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set i_CMOS_Data_0 [ create_bd_port -dir I -from 11 -to 0 i_CMOS_Data_0 ]
  set i_Mode_0 [ create_bd_port -dir I i_Mode_0 ]
  ...
  set i_Switch_0 [ create_bd_port -dir I i_Switch_0 ]
  set i_Trigger [ create_bd_port -dir I -from 0 -to 0 i_Trigger ]
  set i_Trigger_0 [ create_bd_port -dir I i_Trigger_0 ]
  ...
  set o_SYNC_Clk_0 [ create_bd_port -dir O -from 0 -to 0 -type clk o_SYNC_Clk_0 ]

  # Create instance: PL_IO_TriggerCtrl_v1_0, and set properties
  set PL_IO_TriggerCtrl_v1_0 [ create_bd_cell -type ip -vlnv user.org:user:PL_IO_TriggerCtrl_v1_0:1.0 PL_IO_TriggerCtrl_v1_0 ]
  ...
  # Create instance: PL_SPI_ADC_MasterStr_1, and set properties
  set PL_SPI_ADC_MasterStr_1 [ create_bd_cell -type ip -vlnv user.org:user:PL_SPI_ADC_MasterStream_v1_0:1.1 PL_SPI_ADC_MasterStr_1 ]
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#gpio[8]#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#wp#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_intf_net -intf_net PL_SPI_ADC_MasterStr_1_m00_axis [get_bd_intf_pins PL_SPI_ADC_MasterStr_1/m00_axis] [get_bd_intf_pins axi_dma/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins PL_SPI_ADC_MasterStr_1/s00_axi] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins axi_dma/S_AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph/M05_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M07_AXI [get_bd_intf_pins PL_IO_TriggerCtrl_v1_0/s00_axi] [get_bd_intf_pins ps7_0_axi_periph/M07_AXI]

  # Create port connections
  connect_bd_net -net M00_ARESETN_1 [get_bd_pins PL_SPI_ADC_MasterStr_1/m00_axis_aresetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins rst_ps7_0_100M_1/peripheral_aresetn]
  connect_bd_net -net PL_IO_TriggerCtrl_v1_0_o_Trigger [get_bd_pins PL_IO_TriggerCtrl_v1_0/o_Trigger] [get_bd_pins PL_SPI_ADC_MasterStr_1/i_Trigger] [get_bd_pins axi_gpio_0/gpio_io_i]
  ...
  connect_bd_net -net PL_SPI_ADC_MasterStr_0_o_SPI_MOSI [get_bd_ports o_SPI_MOSI_3] [get_bd_pins PL_SPI_ADC_MasterStr_1/i_SPI_MISO] [get_bd_pins PL_SPI_ADC_MasterStr_1/o_SPI_MOSI]
  connect_bd_net -net PL_SPI_ADC_MasterStr_1_o_LED [get_bd_ports o_LED_0] [get_bd_pins PL_SPI_ADC_MasterStr_1/o_LED]
  connect_bd_net -net PL_SPI_ADC_MasterStr_1_o_SPI_CS [get_bd_ports o_SPI_CS_3] [get_bd_pins PL_SPI_ADC_MasterStr_1/o_SPI_CS]
  connect_bd_net -net PL_SPI_ADC_MasterStr_1_o_SPI_Clk [get_bd_ports o_SPI_Clk_3] [get_bd_pins PL_SPI_ADC_MasterStr_1/o_SPI_Clk]
  ...
  connect_bd_net -net PL_SPI_DDS_v1_0_0_o_ADC_Trigger [get_bd_pins PL_SPI_ADC_MasterStr_1/i_ADC_Work] [get_bd_pins PL_SPI_DDS_v1_0_0/o_ADC_Trigger]
  ...
  connect_bd_net -net clk_wiz_1_clk_out2 [get_bd_ports o_SYNC_Clk_0] [get_bd_pins PL_SPI_ADC_MasterStr_1/i_CMOS_Clk] [get_bd_pins PL_SPI_ADC_MasterStr_1/m00_axis_aclk] [get_bd_pins axi_dma/m_axi_s2mm_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_100M_1/slowest_sync_clk]
  connect_bd_net -net i_CMOS_Data_0_1 [get_bd_ports i_CMOS_Data_0] [get_bd_pins PL_SPI_ADC_MasterStr_1/i_CMOS_Data]
  connect_bd_net -net i_Mode_0_1 [get_bd_ports i_Mode_0] [get_bd_pins PL_SPI_ADC_MasterStr_1/i_Mode]
  ...
  connect_bd_net -net i_Switch_0_1 [get_bd_ports i_Switch_0] [get_bd_pins PL_IO_TriggerCtrl_v1_0/i_Switch]
  connect_bd_net -net i_Trigger_0_1 [get_bd_ports i_Trigger_0] [get_bd_pins PL_IO_TriggerCtrl_v1_0/i_Trigger]
  connect_bd_net -net i_Trigger_1 [get_bd_ports i_Trigger] [get_bd_pins PL_IO_TriggerCtrl_v1_0/i_Port]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins PL_IO_TriggerCtrl_v1_0/s00_axi_aclk] [get_bd_pins PL_SPI_ADAR_v1_0_0/s00_axi_aclk] [get_bd_pins PL_SPI_ADC_MasterStr_1/s00_axi_aclk] [get_bd_pins PL_SPI_ADF4159_v1_0_0/s00_axi_aclk] [get_bd_pins PL_SPI_DDS_v1_0_0/s00_axi_aclk] [get_bd_pins axi_dma/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/M07_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins PL_IO_TriggerCtrl_v1_0/s00_axi_aresetn] [get_bd_pins PL_SPI_ADAR_v1_0_0/s00_axi_aresetn] [get_bd_pins PL_SPI_ADC_MasterStr_1/s00_axi_aresetn] [get_bd_pins PL_SPI_ADF4159_v1_0_0/s00_axi_aresetn] [get_bd_pins PL_SPI_DDS_v1_0_0/s00_axi_aresetn] [get_bd_pins axi_dma/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x43C50000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PL_IO_TriggerCtrl_v1_0/s00_axi/reg0] -force
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PL_SPI_ADAR_v1_0_0/s00_axi/reg0] -force
  assign_bd_address -offset 0x43C20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PL_SPI_ADC_MasterStr_1/s00_axi/reg0] -force
  assign_bd_address -offset 0x43C30000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PL_SPI_ADF4159_v1_0_0/s00_axi/reg0] -force
  assign_bd_address -offset 0x43C40000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PL_SPI_DDS_v1_0_0/s00_axi/reg0] -force
